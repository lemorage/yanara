...
@pytest.fixture
def lark_service(table_model):
    """Fixture to create an instance of LarkTableService."""
    return LarkTableService(app_token="test_app_token", table_model=table_model)
...
def test_fetch_records_within_date_range(mock_send_request, mock_client, mock_get_credentials, lark_service):
    ...
    # Act
    result = lark_service.fetch_records_within_date_range(field_names, filter_field_name, start_date_str, end_date_str)
